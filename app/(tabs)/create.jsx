...
const Create = () => {
  ...
  const pickImage = async () => {
    try {
      ...
      if(Platform.OS !== 'web'){
        ...
        if(status !== 'granted'){
          Alert.alert("Permission Denied", "We need camera roll permission to upload na image");
          return;   
        }
      }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/auth/add-book`, {
        method: "POST",
        headers:{
      ...
      Alert.alert("Success", "Your book recommendation hase been posted");
